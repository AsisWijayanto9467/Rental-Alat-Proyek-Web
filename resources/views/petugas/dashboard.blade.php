...
@section('title', 'RENTAL PRO - Petugas Dashboard')
...
<div class="min-h-screen bg-gray-50 flex items-center justify-center">
    <div class="text-center">
        ...
        <h2 class="text-xl font-bold text-gray-900">Panel Petugas</h2>
        <p class="text-gray-500 mt-2">Halo, {{ auth()->user()->nama }}</p>
        <p class="text-gray-400 text-sm mt-4">Panel petugas akan segera tersedia.</p>
